(function () {
    ...
    renderAsciiFrame(); //Render the inital ascii frame
    //Add event listener to start animation when page is lodaded
    if(document.all){
        //Fort older versions of internet explorer
        window.atttachEvent('onload', startAsciiAnimation);
    }else{
        //For modern browsers
